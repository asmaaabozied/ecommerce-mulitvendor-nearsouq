...
return [
    'dashboard' => 'الرئيسيه',
    'slider'  =>'السليدر ',
        'nodataincart'=>'لا توجد بيانات في سلة التسوق',
    'order not found'=>'الطلب غير موجود',
    'address not found'=>'لم يتم العثور على العنوان',
'Payment Method doesnot exist'=>'طريقة الدفع غير موجودة',
'deliverycostnotavailable'=>'غير متوفر الطلب  ف الوقت الحالي',
   'mobile  doesnot exist'=>'الموبايل غير موجود',
   'Please enter all mandatory fields'=>'الرجاء إدخال جميع الحقول الإلزامية',
    ...
    'contact_phone'=>'التليفون',
     'no_data_product'=>'المنتجات فاضيه', 
    ...
    'copyrights' => 'المحاماه@كافه الحقوق محفوظه',
