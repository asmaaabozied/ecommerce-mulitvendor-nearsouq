...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'phone', 'password', 'code', 'image', 'type', 'status', 'latitude', 'address', 'longitude', 'platform'
    ];
    ...
    protected $hidden = [
        ...
        "updated_at",
        "deleted_at","platform",
        "deleted_by","onesignal_id","_token","code","status","email_verified_at","typeReg","type","address","latitude","longitude","last_name"
    ];
    /**
